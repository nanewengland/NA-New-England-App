...
export class MeetingListProvider {
  ...
  meetings : any;
  nernaBMLT : any = "https://www.nerna.org/main_server/client_interface/json/";
  tomatoBMLT : string = "https://tomato.na-bmlt.org/main_server/client_interface/json/";

  constructor(public http: HttpClient) {
  }

    getApiUrl : string = this.nernaBMLT + "?switcher=GetSearchResults&services[]=2&services[]=1&services[]=3&services[]=4&services[]=6&services[]=7&services[]=8&services[]=9&services[]=10&services[]=11&services[]=13&services[]=14&services[]=15&sort_keys=longitude,latitude";
    ...
    getCircleMeetings(lat, long, radius) {
        var getApiUrlCircleMap : string = this.nernaBMLT + "?switcher=GetSearchResults&services[]=2&services[]=1&services[]=3&services[]=4&services[]=6&services[]=7&services[]=8&services[]=9&services[]=10&services[]=11&services[]=13&services[]=14&services[]=15&geo_width_km=" + radius + "&long_val=" + long + "&lat_val=" + lat + "&sort_keys=longitude,latitude&callingApp=na-italia.org";
